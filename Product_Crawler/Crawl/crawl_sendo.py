...
def crawl_category_id(category_url="https://www.sendo.vn/cong-nghe/thiet-bi-di-dong/"):
    ...
    if str_data is not None:
        ...
        try:
            ...
            items_url = "https://www.sendo.vn/m/wap_v2/category/product?category_id={}&p=1&s=60" \
                        "&sortType=default_listing_desc".format(category_id)
...
def build_category_relationship(xml_path="./Data/Sendo/category.xml"):
    ...
    for i, cat_url in enumerate(urls):
        ...
        if len(cat_info) > 0:
            ...
            category_df.append((cat_url, cat_id, cat_name, num_items,
                                parent_ids, sub_ids))
    ...
    category_df = pd.DataFrame(category_df, columns=columns)
    save_path = "./Data/Sendo/sendo_category.csv"
    utils.save_csv(category_df, save_path)
